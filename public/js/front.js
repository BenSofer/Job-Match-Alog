...
// ------------------------------------------------------- //
// For a demo purpose, can be deleted
// ------------------------------------------------------ //

function demo() {

    var themeStylesheet = $('link#theme-stylesheet');

    if ($.cookie("theme_csspath")) {
        themeStylesheet.attr("href", $.cookie("theme_csspath"));
    }
    ...
    $("#colour").change(function () {
        ...
        if ($(this).val() !== '') {
            ...
            themeStylesheet.attr("href", theme_csspath);
